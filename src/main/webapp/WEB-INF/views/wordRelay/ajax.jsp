...
<c:set var="result" value="${result }" ></c:set>
	...
	if(result == 1 ) {%>
		<div class="gameOver"><h1>GAME OVER</h1><h2>끝말을 이어주세요!</h2><a href="game">넘어가기</a></div>
		<div class="userAnswer">
		</div>
		<div class="computerAnswer">
		<h1 class="computerWord" style="font-size: 16px;"></h1>
		</div>
	<% }else if(result == 2 ) {%>
		<div class="gameOver"><h1>GAME OVER</h1><h2>등록된 단어가 아니예요!</h2><a href="game">넘어가기</a></div>
		<div class="userAnswer">
		</div>
		<div class="computerAnswer">
		<h1 class="computerWord" style="font-size: 16px;"></h1>
	...
	<% }else if(result == 3 ) {%>
		<div class="gameOver"><h1>GAME OVER</h1><h2>이미 사용한 단어예요!</h2><a href="game">넘어가기</a></div>
		<div class="userAnswer">
		</div>
		<div class="computerAnswer">
		<h1 class="computerWord" style="font-size: 16px;"></h1>
	...
	<% }else if(result == 4 ) {%>
		...
		<c:forEach var="answer" items="${answer }">
			<div class="computerAnswer">
				<h1 class="computerWord">${answer.word }</h1>
				<p>${answer.def }</p>
			</div>
		</c:forEach>
		<div class="userAnswer">
