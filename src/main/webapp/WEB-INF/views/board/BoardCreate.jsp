						...
						<form method="post" modelAttribute="board">
							<div class="form-group">
								<label for="title">제목</label> <input type="text"
									...
									style="font-size: 25px; height: 34px;">
							</div>
							<div class="form-group">
								<label for="content" style="margin-top: 20px;">내용</label>
								<textarea class="form-control" rows="5" id="content"
									maxlength="300" name="content" placeholder="내용 작성"
									required="required" style="font-size: 25px;"></textarea>
							</div>
							<div class="form-group">
								<label for="writer" style="margin-top: 20px;">작성자</label> <input
									value="<%=userid%>" readonly="readonly" type="text"
									class="form-control" id="writer" name="userId"
